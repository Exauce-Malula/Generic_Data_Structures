...
bool DynArray::isFull(){        // Method which checks if the dynamic array is full.
    if (utilisedSize >= size){
        return true;            // Returns true if the dynamic array is full.
    }
    return false;               // Otherwise, returns false.
}

void DynArray::doubleSize(){                                    // Method which doubles the size of the dynamic array when it is full.
...
bool DynArray::isEmpty(){       // Method which checks if the dynamic array is empty. 
...
void DynArray::push_back(void* element, Datatypes type){    // Method which appends an element to the end of the array.
...
unsigned char DynArray::getSize(){    // Returns the current size of the array.
    return this->size;
}

unsigned char DynArray::getUtilisedSize(){    // Returns the utilised size of the array.
