...
class LinkedList{
    ...
    public:
        ...
        LinkedList* insert_element_LinkedList(void* data, Datatypes type);       // Function method declaration, inserts a node at the head of the Linked List.
        LinkedList* getNode(size_t index);                                       // 
